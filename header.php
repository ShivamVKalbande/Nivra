...
<head>
  ...
  <title>Viksit Trade | Premium Indian Spices Exporter (Turmeric & Chilli)</title>
  <meta name="description" content="Viksit Trade is a government-approved Indian exporter specializing in premium turmeric, red chilli, and high-quality Indian spices. Based in India, serving global markets." />
  <meta name="keywords" content="Viksit Trade, Indian Spices Exporter, Turmeric Exporter India, Red Chilli Supplier, Premium Spices India" />

  <meta property="og:type" content="website" />
  <meta property="og:title" content="Viksit Trade | Premium Indian Spices Exporter" />
...
<header>
  <nav>
    <a href="<?= $isHome ? '#home' : 'index.php#home'; ?>" class="logo-box">
      <img src="./images/logo-transparent.png" alt="Viksit Trade Logo" />
      <span>Viksit Trade</span>
    </a>
        ...
        <div class="dropdown-content">
          <div class="nested-dropdown">
            ...
            <div class="nested-content">
              ...
              <a href="product-details.php?id=cumin-seeds-premium">Cumin seeds</a>
            </div>
          </div>
        </div>
      </div>
